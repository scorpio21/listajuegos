<?php
set_time_limit(0);
$base = 'https://psxdatacenter.com/pal_list.html';
$prefix = 'https://psxdatacenter.com/games/';
$output = fopen('psx_pal_list.csv', 'w');
...
preg_match_all('~games/(S[CL]ES-\d+\.html)~', $html, $matches);
...
fclose($output);
echo "<br>¡Listo! Archivo psx_pal_list.csv generado con $contador juegos y acentos correctos.";
?>
